...
class RecentPhotosTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    private func fetchRecentPhotos() {
        guard let url = URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.getRecent&api_key=4ff20dc6540108d0ee98865e0d7b5d45&format=json&nojsoncallback=1&extras=description,owner_name,icon_server,url_n,url_z") else { return }
    ...
    private func searchPhotos(with text: String) {
        guard let url = URL(string: "https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key=4ff20dc6540108d0ee98865e0d7b5d45&text=\(text)&format=json&nojsoncallback=1&extras=description,owner_name,icon_server,url_n,url_z") else { return }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        NetworkManager.shared.fetchImage(with: photo?.buddyIconUrl) { data in cell.ownerImageCell.image = UIImage(data: data)
        }
